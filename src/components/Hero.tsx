  ...
  return (
    <section className="px-4 pb-16 pt-12 md:pt-16">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div>
          <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-[#0b3a82]">
          ...
          <motion.h1
            ...
            className="max-w-2xl text-4xl font-black tracking-tight text-slate-900 md:text-6xl"
          >
            {siteContent.hero.heading}
          </motion.h1>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="mt-5 max-w-2xl text-lg text-slate-600">
